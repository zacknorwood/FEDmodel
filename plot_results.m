...
while PORCESS_RESULTS==1    
    ...
    BTES_Sch=BTES_Sch(1:ttot,ttot+1:end);
    ...
    BTES_Sloss=BTES_Sloss(1:ttot,ttot+1:end);
    ...
    BTES_Dloss=BTES_Dloss(1:ttot,ttot+1:end);
    ...
    while DISP_RESULTS==1
        ...
        BITES_cap=BITES_Scap.*B_BITES' + BITES_Dcap.*B_BITES';
        ydata=1000*BITES_cap;
        %time=(1:length(ydata))/(24*30);
        xdata=1:30;
        ...
        ylabel('Cpacity [kW]','FontSize',Font_Size,'FontName','Times New Roman')
        set(gca,'FontName','Times New Roman','FontSize',Font_Size)
        %set(gca,'YTickLabel',{'0','1'},'FontName','Times New Roman','FontSize',Font_Size)
        box off
        %xlim([0 30])
        %ylim([0 2])
        %% PLot invested PV capacities on different roofs
        ...
        %bar(xdata,ydata)        
        xlabel('Buildings []','FontSize',Font_Size,'FontName','Times New Roman')        
        ylabel('Cpapacity Roof [kW]','FontSize',Font_Size,'FontName','Times New Roman')        
        set(gca,'FontName','Times New Roman','FontSize',Font_Size)
        %set(gca,'YTickLabel',{'0','1'},'FontName','Times New Roman','FontSize',Font_Size)
        box off
        xlim([0 BID])
        %ylim([0 2])
        %% PLot invested PV capacities on different walls
        ...
        xlabel('Buildings []','FontSize',Font_Size,'FontName','Times New Roman')        
        ylabel('Cpapacity Wall [kW]','FontSize',Font_Size,'FontName','Times New Roman')
        set(gca,'FontName','Times New Roman','FontSize',Font_Size)
        %set(gca,'YTickLabel',{'0','1'},'FontName','Times New Roman','FontSize',Font_Size)
        box off
        %xlim([0 BID])
